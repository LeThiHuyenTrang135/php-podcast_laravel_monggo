...
class PodcastsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('podcasts')->insert([
            [
                '_id' => new ObjectId('6755cba57dd3691c230ec509'),
                'title' => '5.0.2 Reboot',
                ...
                'duration' => 3600,
                'category_id' => '6755cba57dd3691c230ec4ff',
            ...
            [
                '_id' => new ObjectId('6755cba57dd3691c230ec50a'),
                'title' => '5.0.1 Voice',
                ...
                'duration' => 2700,
                'category_id' => '6755cba57dd3691c230ec500',
                'podcaster_id' => '6755cba57dd3691c230ec505',
                'created_at' => new UTCDateTime(now()->timestamp * 1000),
                'updated_at' => new UTCDateTime(now()->timestamp * 1000),
            ],
            [
                '_id' => new ObjectId('6755cba57dd3691c230ec50b'),
                'title' => '4.0.1 Faith',
            ...
            [
                '_id' => new ObjectId('6755cba57dd3691c230ec50c'),
                'title' => '3.0.2 Space',
                ...
                'duration' => 2700,
                'category_id' => '6755cba57dd3691c230ec501',
                'podcaster_id' => '6755cba57dd3691c230ec506',
                'created_at' => new UTCDateTime(now()->timestamp * 1000),
                'updated_at' => new UTCDateTime(now()->timestamp * 1000),
            ],
            [
                '_id' => new ObjectId('6755cba57dd3691c230ec50d'),
                'title' => '2.0.9 Drama',
                ...
                'duration' => 3300,
                'category_id' => '6755cba57dd3691c230ec502',
                'podcaster_id' => '6755cba57dd3691c230ec507',
                'created_at' => new UTCDateTime(now()->timestamp * 1000),
                'updated_at' => new UTCDateTime(now()->timestamp * 1000),
            ],
            [
                '_id' => new ObjectId('6755cba57dd3691c230ec50e'),
                'title' => '2.0.8 Learn',
                ...
                'duration' => 2700,
                'category_id' => '6755cba57dd3691c230ec503',
                'podcaster_id' => '6755cba57dd3691c230ec508',
                'created_at' => new UTCDateTime(now()->timestamp * 1000),
                'updated_at' => new UTCDateTime(now()->timestamp * 1000),
            ],
            [
                '_id' => new ObjectId('6755cba57dd3691c230ec50f'),
            ...
            [
                '_id' => new ObjectId('6755cba57dd3691c230ec510'),
                'title' => '2.0.5 Typo',
            ...
            [
                '_id' => new ObjectId('6755cba57dd3691c230ec511'),
                'title' => '2.0.4 Taste',
            ...
            [
                '_id' => new ObjectId('6755cba57dd3691c230ec512'),
