...
<body>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-8">
            ...
            <div class="container pt-5">
                ...
                <form action="{{ route('podcast.addPodcast') }}" method="POST" enctype="multipart/form-data" id="podcast_create_form">
                  @csrf
  ...
  {{-- <script src="{{ asset('assets/js/create-podcast.js') }}"></script> --}}
