                  ...
                  <div class="form-group">
                      ...
                      @if($podcast->image)
                          <div class="mt-2">
                              <img 
                              src="{{ 
                                  str_contains($podcast->image, 'http')
                                      ? $podcast->image
                                      // : asset('assets/images/' . $podcast->image))
                                      : asset('storage/podcasts/images/' . $podcast->image)
                              }}"
                              {{-- src="{{ asset('storage/podcasts/images/' . $podcast->image) }}"  --}}
